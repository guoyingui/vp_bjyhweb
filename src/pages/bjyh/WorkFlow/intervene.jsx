...
import { VpAlertMsg,VpFInput,VpOption,VpSelect,VpFSelect,VpForm,vpAdd, vpQuery, VpModal, VpTable, VpIcon, VpTooltip, VpRow, VpCol, VpFormCreate,VpInput } from 'vpreact';
import {
    SeachInput,
    CheckRadio,
    RightBox,
...
class intervene extends Component {
    ...
    handleOkResion = () => {
        ...
        this.okUserModal(this.state.selectItem)
    }
    handleCancelResion = () => {
        this.setState({
            visibleResion:false,
                ...
                >
                   {
                            this.state.userModal ?
                                <ChooseEntity
                                    ...
                                    onOk={(selectItem) => _this.okUserModalBefore(selectItem)}
                                />
                                :
                                null
                        }
