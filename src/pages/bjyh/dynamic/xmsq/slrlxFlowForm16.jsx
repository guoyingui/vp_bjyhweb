...
import {validationRequireField, singleInputFill,initHiddenColumn,xmsqHiddenColumni,initHiddenColumn_history  } from '../code';
 ...
 * 受理人立项
 */
class slrlxFlowForm16 extends FlowForm.Component {
    constructor(props) {
        super(props);
...
slrlxFlowForm16 = FlowForm.createClass(slrlxFlowForm16);
export default slrlxFlowForm16;