 ...
 * 业务线领导审批
 */
class ywxldspFlowForm13 extends FlowForm.Component {
    constructor(props) {
        super(props);
    ...
    onDataLoadSuccess = (formData,_handlers) => {
        ...
        let sywxldsp = formData.findWidgetByName("sywxldsp");
            
        if(scondition.field.fieldProps.initialValue == 'SYSZ'){
            sywxldsp.field.fieldProps.rules[0].required = true
        }
    }
    ...
    handleCondition(e) {
        ...
        let _this = this
        let flag = e.target.value == 'SYSZ' ? true : false
        validationRequireField(_this, 'sywxldsp', flag)
                 
    }

    onBeforeSave = (_formData,_btnName)=>{
        singleInputFill(_formData, _btnName, 'sywxldsp', true)
    }
...
ywxldspFlowForm13 = FlowForm.createClass(ywxldspFlowForm13);
export default ywxldspFlowForm13;