 ...
 * PMO分级
 */
class pmofj07 extends FlowForm.Component {
    constructor(props) {
        super(props);
        this.state.moduserprops={
            ismoduser:false,//是否启用更改处理人
        }
    }
    componentWillMount() {
    ...
    onBeforeSave = (formData,btnName)=>{
        ...
        let ixmdj = sparam.ixmdj
        if(btnName == "ok"){
            if(ixmdj == 5 || !ixmdj || ixmdj==0){
                VpAlertMsg({
                    message: "消息提示",
                    description: "项目等级不能为无，必须选择",
                    type: "warning",
...
pmofj07 = FlowForm.createClass(pmofj07);
export default pmofj07;