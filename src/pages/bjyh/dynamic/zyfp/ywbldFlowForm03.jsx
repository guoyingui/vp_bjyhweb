...
class ywbldFlowForm03 extends FlowForm.Component {
    ...
    componentWillMount() {
        ...
        vpQuery('/{vpplat}/vfrm/entity/listDatas', {
            ...
            if(res.data){
                ...
                moduserprops.moduserCondition[0].field_value=ids.toString()+",100012"//集成运维部的所有用户
       ...
       if(isfddzyyw&&dddksyw){
           ...
           isfddzyyw.field.fieldProps.onChange = e =>{
                if(e == 0){//0是1否
                    ...
                    _this.props.form.setFieldsValue({dddksyw:'',dddjsyw:''})
                }

                _this.props.form.validateFields(['ryweidb','ryweidb_label','dddjsyw'],{force:true})
           }
       } 
    ...
    onBeforeSave = (formData, btnName) => {
        ...
        if(btnName=='ok'){
            if(scondition!='SYSK'){
                sparam.dddjsyw = moment().format('YYYY-MM-DD hh:mm:ss')
