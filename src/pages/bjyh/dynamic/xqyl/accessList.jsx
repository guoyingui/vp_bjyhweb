...
class AccessList extends Component {
    ...
    splitUserOk = (ids) => {
        ...
        this.props.form.validateFields((errors, values) => {
            ...
            jsonPara = {
                ...
                flow_type: 1,//流程类型：1需求用例新增，2未关联项目的需求用例变更，3已关联项目的需求用例变更，4需求用例与项目关联，5上线流程';
    ...
    getData() {
       ...
       console.log("this,",this)
        if(this.props.stepcode == "03"){ //领导会签接口
            console.log("isHistory23",isHistory)
                    ...
                    <VpRow key='s1' className='ant-row ant-form-item'>
                        <VpCol key='case_code' span='12'>
                            <VpFInput disabled {...getFieldProps('case_code', {
                                ...
                                label="用例编号" labelCol={{ span: 6 }} wrapperCol={{ span: 14 }}
                            />
                        </VpCol>
    ...
    handleSubmit = (type) => {
        if (type == 'upload') {
            ...
            //导入数据
            let s=this.inputUploader.upload.upload()
        } else {
            const _this = this;
            let condition = {
                filePath: '',
                                ...
                                <VpRow span={24}>
                                    ...
                                    {<VpCol className="gutter-row" span={22}>
                                        <VpUploader
                                            ...
                                            onUploadAccept={this.uploadFilesSuccess}
                                            params={{
                                                entity_id: this.state.parentForm.props.iobjectentityid,
                                                flow_id: this.props.piid,
                                                user_code: vp.cookie.getTkInfo('username'),
