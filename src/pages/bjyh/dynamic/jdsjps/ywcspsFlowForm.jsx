 ...
 * 阶段业务测试用例评审流程
 */
class ywcspsFlowForm extends FlowForm.Component {
    constructor(props) {
        super(props);
    }
        ...
        for (let item of handlers) {
            if (item.stepcode == 'upload') {//上传文档步骤
                ...
                if (step && !step.field.fieldProps.initialValue) {//已经有值，不重新设置值
                    vpQuery('/{bjyh}/phaseFlow/getYwdb', {
...
ywcspsFlowForm = FlowForm.createClass(ywcspsFlowForm);
export default ywcspsFlowForm;