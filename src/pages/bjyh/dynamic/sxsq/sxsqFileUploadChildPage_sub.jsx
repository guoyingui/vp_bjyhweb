...
// 需求分析流程--流程子表单
class sxsqFileUploadChildPage_sub extends Component {
    constructor(props) {
        super(props);
        this.state = {
            number: 1,
     ...
     */
    getDataUrl = () => {
        return '/{bjyh}/sxsqFileUploadChildPageRest/list_sub';
    }
    ...
    render() {
        ...
        return (<div style={{ marginLeft: 0, marginRight: 60 ,padding: '0 5%'}}>
            <div style={{ textAlign: "right", marginBottom: 5 }}></div>
            <VpTable
...
sxsqFileUploadChildPage_sub = EditTable.createClass(sxsqFileUploadChildPage_sub)
export default sxsqFileUploadChildPage_sub
