...
class wbsRelate extends Component {
    constructor(props) {
        super(props)
        this.state = {
            filters: [],
    ...
    saveRowData(value, statusid) {
        ...
        value['preentityid'] = this.state.entityid
    ...
    queryFormData() {
        ...
        vpAdd('/{vpmprovider}/vfrm/phase/getForm',
            ...
            _this.setState({
                ...
                projectname: namestr,
                params: {
                    entityrole: true, iid: _this.state.projectid, phaserelentityid: '7'
                }
...
export default wbsRelate = VpFormCreate(wbsRelate);