...
class RelReqCaseModal extends Component{
    ...
    getListData() {
        ...
        let jsonPara={//项目code，项目name
                pageNum:cur_page,pageSize:limit,
                quickSearch:this.state.quickvalue,
                flow_id:this.props.piid,
                project_code:this.props.project_code,
                flow_type:5
            }
        vpAdd(window.vp.config.jgjk.sxsq.sxsqRelReqCaseListUrl, {
    ...
    onOk() {
        ...
        vpAdd(window.vp.config.jgjk.sxsq.sxsqRelReqCaseUrl,{jsonPara:JSON.stringify(jsonPara)}).then(res=>{
            this.setState({
                selectItem: []
            },()=>{
                this.props.onOk();
