...
export class VpFUploader extends React.Component {
    ...
    componentDidMount() {
        ...
        let _uploader = uploader.create({
            ...
            timeout: 0,
            auto: true,
            server: vp.gateway.handleGateWay(this.uploadUrl || '/{vpcloud}/upload'),
            pick: {
                id: this.refs.upload,
                multiple: false,
            },
                                                        ...
                                                        {file.creator ? <span>上传人: {file.creator} </span> : null}&nbsp;&nbsp;&nbsp;
                                                        {
                                                            ...
                                                            file.createtime ? this.props.godMode ?
                                                                <span>上传时间:<VpDatePicker format="yyyy-MM-dd HH:mm:ss" onChange={(e) => this.createTimeOnChange(e, idx)}
                                                                    showTime defaultValue={new Date(parseInt(file.createtime))} />
                                                                </span>
                                                                :
                                                                <span>上传时间:{formatDateTime(new Date(parseInt(file.createtime)))} </span>
                                                                : null
                                                        }
                                                    </p>
                                                </li>
