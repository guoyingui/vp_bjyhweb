try {
		...
		vpPostAjax(getVpmPath() + '/vpmwbs/saveTasks', params, "POST", function(rst) {		
			if (rst.success) {
				...
				if(quit){
					...
					try{
						if(parent.location.href.indexOf("wbs_task_std")!=-1 || parent.location.href.indexOf("wbs_task_2nd")!=-1 ||
								parent.location.href.indexOf("wbs_task_std2")!=-1 || parent.location.href.indexOf("wbs_task_2nd2")!=-1
						){
							var uu = parent.document.getElementById("leftFrame").contentWindow.document.getElementById("infoIframe").contentWindow.document.getElementById("formIframe").src;
							parent.document.getElementById("leftFrame").contentWindow.document.getElementById("infoIframe").contentWindow.document.getElementById("formIframe").src = uu;
						}else{
								var url = parent.document.getElementById("rightFrame").contentWindow.document.getElementById("infoIframe").contentWindow.document.getElementById("menuChild").contentWindow.document.getElementById("formIframe").src;
								parent.document.getElementById("rightFrame").contentWindow.document.getElementById("infoIframe").contentWindow.document.getElementById("menuChild").contentWindow.document.getElementById("formIframe").src = url;
						}
					}catch(e){
						try{
	...
	vpGantt.reloadProject=function(){
		...
		*/
		try
		{			
			var url = parent.document.getElementById("rightFrame").contentWindow.document.getElementById("menuCard").contentWindow.document.getElementById("menuChild").src;
			parent.document.getElementById("rightFrame").contentWindow.document.getElementById("menuCard").contentWindow.document.getElementById("menuChild").src = url;
		}
		catch (e)
		{
		}
